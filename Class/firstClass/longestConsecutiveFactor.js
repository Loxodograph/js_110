/*
  - Problem
    ...
    - Output: Array containing longest streak of consecutive
  ...
  - Algorithm
    - CREATE function called longestConsecutiveFactors which takes
      two arguments, an inputArr and inputNum
...
function longestConsecutiveFactors(inputArr, inputNum) {
  ...
  for (let idx = 0; idx < inputArr.length; idx++) {
    if (inputNum % inputArr[idx] === 0) {
      currentSequence.push(inputArr[idx]);
